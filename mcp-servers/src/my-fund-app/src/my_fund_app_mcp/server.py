...
SERVER_INSTRUCTIONS = (
    "Read-only myFund.pl portfolio dashboard app. Fetch and visualize live portfolio data, "
    "but do not execute trades, rebalance, mutate account data, or expose credentials."
)
